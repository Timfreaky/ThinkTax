	...
	function weblizar_default_settings()
{
	...
	{  							
	   return '<div class="blog-post-details-item"><a class="enigma_blog_read_btn" href="'.get_permalink().'"><i class="fa fa-plus-circle"></i>"'.__('Suite...', 'weblizar' ).'"</a></div>';
	}   
	...
	*/
    ...
    if (is_category()) {
        ...
        echo $before . _e("Résultats de la recherche pour","weblizar")  . get_search_query() . '"' . $after;
        ...
        echo $before . _e("Articles postés par","weblizar") . $userdata->display_name . $after;
    } elseif (is_404()) {
        echo $before . _e("Erreur 404","weblizar") . $after;
    }
