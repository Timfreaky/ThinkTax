<div id="post-<?php the_ID(); ?>" <?php post_class('enigma_blog_full'); ?>>
	...
	<div class="post-content-wrap">
		...
		<p class="enigma_cats"><?php echo __("Categorie : ",'weblizar');
		the_category(' , '); ?></p>
		<?php } ?>
		</div>
		</div>
		<?php the_content( __( 'Suite...' , 'weblizar' ) ); 
		$defaults = array(
	          ...
	          'separator'        => ' ',
	          'nextpagelink'     => __( 'Page suivante'  ,'weblizar' ),
	          'previouspagelink' => __( 'Page précédente' ,'weblizar'),
	          'pagelink'         => '%',
	          'echo'             => 1
	          );
