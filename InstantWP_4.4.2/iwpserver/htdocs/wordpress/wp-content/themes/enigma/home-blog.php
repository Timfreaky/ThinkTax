...
if($wl_theme_options['blog_title'] !='') { ?>
	...
	<?php 	if ( have_posts()) : 			
			...
			<div class="enigma_blog_thumb_wrapper">
				...
				<?php } ?>
				<?php the_excerpt( __( 'Suite...' , 'weblizar' ) ); ?>
				<a href="<?php the_permalink(); ?>" class="enigma_blog_read_btn"><i class="fa fa-plus-circle"></i><?php _e('Suite...','weblizar'); ?></a>
			...
			<div class="enigma_blog_thumb_wrapper">
				...
				<a href="#" class="enigma_blog_read_btn"><i class="fa fa-plus-circle"></i><?php _e('Suite...','weblizar'); ?></a>
				<div class="enigma_blog_thumb_footer">
					<ul class="enigma_blog_thumb_date">
